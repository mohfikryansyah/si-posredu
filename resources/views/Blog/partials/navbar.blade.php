<nav class=" bg-white">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="{{ env('APP_URL') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span
                class="self-center text-2xl font-semibold font-abyssinica text-[#008cb5] whitespace-nowrap dark:text-white">POSREDU</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul id="navbar"
                class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                ...
                <li>
                    <a href="{{ route('home.index') }}#profil"
                ...
                <li>
                    <a href="{{ route('home.index') }}#jadwal_pelayanan"
                ...
                <li>
                    <a href="{{ route('home.index') }}#artikel"
                ...
                <li>
                    <a href="{{ route('home.index') }}#galeri"
                ...
                <li>
                    <a href="{{ route('home.index') }}#kontak"
