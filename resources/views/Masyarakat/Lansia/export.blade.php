        ...
        <form action="{{ route('pemeriksaanLansia.export') }}" method="GET" class="mt-4">
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
                <div class="col-span-2">
                    <label for="lansia_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama<span
                    ...
                    <select id="export_lansia_id" name="lansia_id"
                        ...
                        style="width: 100%;">
                        <option value="{{ Auth::user()->lansia_id }}" selected read>{{ Auth::user()->lansia->nama }}
                        </option>
                    </select>
                ...
                <div class="md:col-span-1 col-span-2">
                    ...
                    <x-date-input name="start" id="start"
                        class="{{ $errors->export_pemeriksaan_lansia->has('start') ? 'border-red-500' : 'border-gray-300' }}"
                ...
                <div class="md:col-span-1 col-span-2">
                    ...
                    <x-date-input name="end" id="end"
                        class="{{ $errors->export_pemeriksaan_lansia->has('end') ? 'border-red-500' : 'border-gray-300' }}"
